Shader "Custom/C17_NormalExtrusion" {
	Properties {
	...
	SubShader {
		...
		// nometa - do not generate a "meta" pass (thats used by lightmapping & dynamic global illumination to extract surface information).
